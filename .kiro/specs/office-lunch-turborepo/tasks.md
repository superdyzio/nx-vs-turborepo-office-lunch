...
- [x] 1. Scaffold the Turborepo workspace root
...
- [x] 2. Create the shared-models package
  - [x] 2.1 Create `turborepo/packages/shared-models/` structure with `src/lib/` and `index.ts`
...
- [x] 3. Create the shared-ui package
  - [x] 3.1 Create `turborepo/packages/shared-ui/` structure with `src/lib/`, `src/styles/`, and `index.ts`
...
- [x] 4. Create the data-access package
  - [x] 4.1 Create `turborepo/packages/data-access/` structure with `src/lib/repositories/` and `index.ts`
...
- [x] 5. Create the auth package
  - [x] 5.1 Create `turborepo/packages/auth/` structure with `src/lib/` and `index.ts`
...
- [x] 6. Create the util package
  - [x] 6.1 Create `turborepo/packages/util/` structure with `src/lib/` and `index.ts`
...
- [x] 8. Create the feature-login package
  - [x] 8.1 Create `turborepo/packages/feature-login/` structure with `src/lib/login/` and `index.ts`
...
- [x] 9. Create the feature-departure package
  - [x] 9.1 Create `turborepo/packages/feature-departure/` structure with `src/lib/departure/` and `index.ts`
...
- [x] 10. Create the feature-voting package
  - [x] 10.1 Create `turborepo/packages/feature-voting/` structure with `src/lib/voting/` and `index.ts`
...
- [x] 11. Create the feature-ordering package
  - [x] 11.1 Create `turborepo/packages/feature-ordering/` structure with `src/lib/ordering/` and `index.ts`
...
- [x] 12. Create the feature-admin package
  - [x] 12.1 Create `turborepo/packages/feature-admin/` structure with `src/lib/` subdirectories and `index.ts`
...
- [x] 13. Checkpoint — feature packages
  - Ensure all feature package lint targets pass (no cross-boundary import violations)
  - Ensure all tests pass, ask the user if questions arise.

- [x] 14. Create the shell application
  - [x] 14.1 Create `turborepo/apps/office-lunch/` structure with `src/app/` and config files
  ...
  - [x] 14.4 Write property test: every package has a vitest.config.ts with jsdom environment
    - **Property 4: Every package has a vitest config with jsdom environment**
    - **Validates: Requirements 15.2**

  - [x] 14.5 Write property test: every package has a path alias in root tsconfig.json
    - **Property 5: Every package has a path alias in root tsconfig.json**
    - **Validates: Requirements 1.3**

  - [x] 14.6 Write property test: vitest.workspace.ts references all package vitest configs
